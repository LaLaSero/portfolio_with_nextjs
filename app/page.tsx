...
import styles from './hello/skill_board.module.css';
  ...
  return (
	  <>
		...
		<div style={{ maxWidth: "600px", margin: "auto" }}>
			...
			<TimelineItem date="2024年8月" description="セキュリティキャンプ全国 参加" />
			<TimelineItem date="2023年9月" description="42Tokyo 入学" />
			<TimelineItem date="2021年4月" description="名古屋大学 工学部 機械航空宇宙工学科 入学" />
			<TimelineItem date="2021年3月" description="愛知県立 刈谷高等学校 卒業" />
		</div>
		</div>
